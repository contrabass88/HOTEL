    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disponibilidades', to='core.categoria')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='localidad',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='direcciones', to='core.localidad'),
        ),
        migrations.CreateModel(
            name='Provincia',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.estadoreserva')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserva', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.reservahotel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='viajero',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.viajero'),
        ),
        migrations.CreateModel(
            name='HotelCategoria',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.categoria')),
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categorias_hotel', to='core.hotel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categoria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.categoria')),
                ('servicio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.serviciocategoriahabitacion')),
            ],
            options={
                'verbose_name': 'Servicio por Categoría',
                'verbose_name_plural': 'Servicios por Categoría',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servicio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.serviciohotel')),
            ],
            options={
